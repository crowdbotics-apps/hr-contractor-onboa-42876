...
## Project Structure
    ...
    ├── hr_contractor_onboa_42876  # Django project configurations
...
1. Clone this repo and `cd hr_contractor_onboa_42876`
...
2. Clone this repo and `cd hr_contractor_onboa_42876`
