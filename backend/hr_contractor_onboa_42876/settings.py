"""
Django settings for hr_contractor_onboa_42876 project.
...
ROOT_URLCONF = 'hr_contractor_onboa_42876.urls'
...
WSGI_APPLICATION = 'hr_contractor_onboa_42876.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hr_contractor_onboa_42876 API",
    "DESCRIPTION": "API documentation for hr_contractor_onboa_42876 App",
    "VERSION": "v1",
}
